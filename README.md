...
```
% go get -u code.sajari.com/kagome/...
```
...
```
$ kagome -h
Japanese Morphological Analyzer -- code.sajari.com/kagome
...
For Google App Engine, please use [kagome.ipadic](https://code.sajari.com/kagome.ipadic) which is a small dictionary version of kagome.

see details: https://code.sajari.com/kagome/issues/86
